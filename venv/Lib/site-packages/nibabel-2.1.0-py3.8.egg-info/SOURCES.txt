...
doc/Makefile
doc/README.rst
doc/downloads/someones_anatomy.nii.gz
doc/downloads/someones_epi.nii.gz
doc/misc/header.py
doc/misc/pylintrc
doc/pics/fslview_pst.png
doc/pics/gnuplot_ts.png
doc/pics/reggie.svg
...
doc/source/_static/item.png
doc/source/_static/nibabel.css
doc/source/_static/nipy-logo-bg-138x120.png
doc/source/_static/nipy.css
doc/source/_static/reggie.png
...
doc/source/dicom/dicom_fields.rst
...
doc/source/dicom/mosaic_grid.png
...
doc/source/downloads/someones_epi.nii.gz
...
doc/source/images/illustrating_affine.png
doc/source/images/localizer.png
doc/source/notebooks/.gitignore
doc/source/notebooks/ata_error.ipynb
doc/source/notebooks/cross_product_error.ipynb
...
doc/source/scripts/.gitignore
doc/source/scripts/README.txt
...
nibabel/xmlutils.py
nibabel.egg-info/PKG-INFO
nibabel.egg-info/SOURCES.txt
nibabel.egg-info/dependency_links.txt
nibabel.egg-info/not-zip-safe
nibabel.egg-info/requires.txt
nibabel.egg-info/top_level.txt
...
nibabel/externals/tests/data/example_1.nc
nibabel/freesurfer/__init__.py
nibabel/freesurfer/io.py
nibabel/freesurfer/mghformat.py
nibabel/freesurfer/tests/__init__.py
...
nibabel/gifti/tests/__init__.py
...
nibabel/gifti/tests/data/gzipbase64.gii
nibabel/gifti/tests/data/label.gii
nibabel/gifti/tests/data/rh.aparc.annot.gii
nibabel/gifti/tests/data/rh.shape.curv.gii
...
nibabel/nicom/tests/data/csa2_b0.bin
nibabel/nicom/tests/data/csa2_b1000.bin
nibabel/nicom/tests/data/csa2_zero_len.bin.gz
nibabel/nicom/tests/data/csa_slice_norm.dcm
nibabel/nicom/tests/data/csa_str_200n_items.bin
nibabel/nicom/tests/data/csa_str_valid.bin
nibabel/nicom/tests/data/decimal_rescale.dcm
nibabel/nicom/tests/data/philips_mprage.dcm.gz
nibabel/nicom/tests/data/siemens_dwi_0.dcm.gz
nibabel/nicom/tests/data/siemens_dwi_1000.dcm.gz
...
nibabel/tests/test_endiancodes.py
...
nibabel/tests/test_mriutils.py
...
nibabel/tests/data/0.dcm
nibabel/tests/data/1.dcm
nibabel/tests/data/ASL_3D_Multiecho.PAR
nibabel/tests/data/DTI.PAR
nibabel/tests/data/DTIv40.PAR
nibabel/tests/data/NA.PAR
...
nibabel/tests/data/T1.PAR
nibabel/tests/data/T1_3echo_mag_real_imag_phase.PAR
nibabel/tests/data/T1_dual_echo.PAR
nibabel/tests/data/T2-interleaved.PAR
nibabel/tests/data/T2.PAR
nibabel/tests/data/T2_-interleaved.PAR
nibabel/tests/data/T2_.PAR
nibabel/tests/data/analyze.hdr
...
nibabel/tests/data/empty.trk
nibabel/tests/data/example4d.nii.gz
nibabel/tests/data/example_nifti2.nii.gz
nibabel/tests/data/fieldmap.PAR
nibabel/tests/data/functional.nii
nibabel/tests/data/gen_standard.py
nibabel/tests/data/make_moved_anat.py
nibabel/tests/data/minc1_1_scale.mnc
nibabel/tests/data/minc1_4d.mnc
nibabel/tests/data/minc2_1_scale.mnc
nibabel/tests/data/minc2_4d.mnc
nibabel/tests/data/nifti1.hdr
nibabel/tests/data/nifti2.hdr
nibabel/tests/data/phantom_EPI_asc_CLEAR_2_1.PAR
nibabel/tests/data/phantom_EPI_asc_CLEAR_2_1.REC
nibabel/tests/data/phantom_fake_dualTR.PAR
nibabel/tests/data/phantom_fake_v4.PAR
nibabel/tests/data/phantom_fake_v4_1.PAR
nibabel/tests/data/phantom_truncated.PAR
nibabel/tests/data/phantom_truncated.REC
nibabel/tests/data/phantom_varscale.PAR
nibabel/tests/data/phantom_varscale.REC
nibabel/tests/data/reoriented_anat_moved.nii
nibabel/tests/data/resample_using_spm.m
nibabel/tests/data/resampled_anat_moved.nii
nibabel/tests/data/simple.trk
nibabel/tests/data/small.mnc
nibabel/tests/data/standard.LPS.trk
nibabel/tests/data/standard.nii.gz
nibabel/tests/data/standard.trk
nibabel/tests/data/test.mgz
nibabel/tests/data/tiny.mnc
nibabel/tests/data/tinypet.v
nibabel/tests/data/to_canonical.m
nibabel/tests/data/umass_anonymized.PAR
nisext/__init__.py
