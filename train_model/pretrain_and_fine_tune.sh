...
python pretr_encoder_global_contrastive_loss.py --n_iter=1000 --dataset=us --global_loss_exp_no=2 --n_parts=4 --temp_fac=0.1
...
python3 pretr_decoder_local_contrastive_loss.py --n_iter=1000 --pretr_n_iter=1000 --dataset=us --local_reg_size=1 --no_of_local_regions=13 --temp_fac=0.1 --global_loss_exp_no=2 --local_loss_exp_no=1 --no_of_decoder_blocks=3 --no_of_neg_local_regions=5
...
python3 ft_pretr_encoder_decoder_net_local_loss.py --n_iter=1000 --pretr_n_iter=1000 --dataset=us --local_reg_size=1 --no_of_local_regions=13 --temp_fac=0.1 --global_loss_exp_no=2 --local_loss_exp_no=1 --no_of_decoder_blocks=3 --no_of_neg_local_regions=5 --ver=0
